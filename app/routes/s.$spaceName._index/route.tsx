...
function calculateSchedules(
  ...
  const currentIndex = EVENTS.indexOf(currentEventTitle);
  ...
  return [
    { date: previousEventDate, eventTitle: EVENTS[previousIndex] },
    { date: startDate, eventTitle: currentEventTitle },
    { date: nextEventDate, eventTitle: EVENTS[nextIndex] },
  ];
}
...
export default function SpaceIndex() {
  const { spaceInfo, proposalsPacket } = useOutletContext<{
    spaceInfo: SpaceInfo;
